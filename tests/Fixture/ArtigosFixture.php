...
class ArtigosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'corpo' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'criado' => '2017-09-22 13:40:08',
            'modificado' => '2017-09-22 13:40:08'
        ],
    ];
}
